...
```{r, eval = FALSE}
summaryp(factor.indep, hsic.diff = TRUE, dcor.diff = TRUE,
...
```{r, eval = FALSE}
# point.indep
summaryp(point.indep, hsic.diff = T, dcor.diff = T, mi.diff = T)
```
...
```{r, eval = FALSE}
#mean.indep
summaryp(mean.indep, hsic.diff = TRUE, dcor.diff = TRUE, mi.diff = TRUE)
```
...
```{r, eval = FALSE}
#median.indep
summaryp(median.indep, hsic.diff = TRUE, dcor.diff = TRUE, mi.diff = TRUE)
```
...
```{r, eval = FALSE}
#jn.indep
summaryp(jn.indep.b, hsic.diff = TRUE, dcor.diff = TRUE, mi.diff = TRUE)
```
